...
{
    public class CriptografiaAppService
    {
        /// <summary>     
        ...
        /// A chave é: "A Salvacao com Pertence a *YHWH*"  
        /// Chave convertida para Base64: QSBTYWx2YWNhbyBjb20gUGVydGVuY2UgYSAqWUhXSCo=
        /// Site conversao online para base 64: http://www.motobit.com/util/base64-decoder-encoder.asp
        /// Site conversao online para base 64: http://www.url-encode-decode.com/base64-encode-decode/
        /// Referência Base64: https://pt.wikipedia.org/wiki/Base64
        /// </summary>     

        private const string criptoChave = "QSBTYWx2YWNhbyBjb20gUGVydGVuY2UgYSAqWUhXSCo=";
        ...
        public static string Criptografar(string text)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(text))
                {
                    ...
                    byte[] bKey = Convert.FromBase64String(criptoChave);
        ...
        //    String valorCriptografado = CriptografiaService.Encrypt(valor);
        //    String valorDescriptografado = CriptografiaService.Decrypt(valorCriptografado);
